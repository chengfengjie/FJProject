#
#  Be sure to run `pod spec lint FJDevlopCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "chengfengjie" => "499013124@qq.com" }
  # Or just: s.author    = "chengfengjie"
  # s.authors            = { "chengfengjie" => "499013124@qq.com" }
  # s.social_media_url   = "http://twitter.com/chengfengjie"
